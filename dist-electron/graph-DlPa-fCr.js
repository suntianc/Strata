...
async function createSchema() {
  ...
  const createTableSafe = async (query, tableName) => {
    var _a, _b;
    try {
      await connection.query(query);
    } catch (error) {
      if (!((_a = error.message) == null ? void 0 : _a.includes("already exists")) && !((_b = error.message) == null ? void 0 : _b.includes("Binder exception"))) {
