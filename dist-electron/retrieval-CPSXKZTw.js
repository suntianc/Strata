import { P as PQueueMod, p as pRetry, s as snakeCase, a as styles, g as getEncodingNameForModel, T as Tiktoken, z as zodToJsonSchema, b as anyType } from "./chunk-VL2OQCWN-Cb9Eowls.js";
import { v as v4$2, a as validate$3 } from "./wrapper-YsxZxQQz.js";
...
import { findMessagesByTag } from "./graph-DlPa-fCr.js";
import { query } from "./pg-C--6FeAb.js";
...
class CallbackManager extends BaseCallbackManager {
  ...
  async handleRetrieverStart(retriever, query2, runId = v4$2(), _parentRunId = void 0, _tags = void 0, _metadata = void 0, runName = void 0) {
    await Promise.all(this.handlers.map((handler) => consumeCallback(async () => {
      var _a;
      if (!handler.ignoreRetriever) {
        try {
